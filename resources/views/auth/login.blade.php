...
<body>
    ...
    <div class="relative h-screen w-screen bg-white">
        {{-- <div style="background-image: url('{{ asset('image/SignIn.png') }}');" class="w-full h-full bg-cover absolute "> --}}
    </div>

    <div
        class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col m-6  space-y-4 bg-white shadow-2xl rounded-2xl lg:flex-row md:space-y-0 lg:max-w-screen">
