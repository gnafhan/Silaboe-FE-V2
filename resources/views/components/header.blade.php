...
<nav class="bg-[#4C8F8B] border-gray-200 ">
            ...
            <ul
                ...
                <li>
                    <a href="{{ route('datasoftware.login') }}"
                        class="block py-2 px-3 rounded md:p-0 {{ Request::routeIs('datasoftware.login') ? 'text-yellow-500 ' : ' lg:text-lg md:text-md md:hover:bg-transparent md:hover:text-yellow-500 text-white md:dark:hover:text-yellow-500 dark:hover:bg-white dark:hover:text-gray-500 md:dark:hover:bg-transparent ' }}">DATA
                        SOFTWARE</a>
                </li>
                <li>
                    <a href="{{ route('inventaris.login') }}"
                        class="block py-2 px-3 rounded md:p-0 {{ Request::routeIs('inventaris.login') ? 'text-yellow-500 ' : ' lg:text-lg md:text-md md:hover:bg-transparent md:hover:text-yellow-500 text-white md:dark:hover:text-yellow-500 dark:hover:bg-white dark:hover:text-gray-500 md:dark:hover:bg-transparent dark:border-gray-700' }}">INVENTARIS</a>
                </li>
                <li>
                    <a href="{{ route('laboratorium.login') }}"
                        class="block py-2 px-3 rounded md:p-0 
                              {{ Request::routeIs('login/landingpage/laboratorium*') ? 'text-yellow-500' : ' hover:bg-gray-100 text-lg md:text-md md:hover:bg-transparent md:hover:text-yellow-500 text-white md:dark:hover:text-yellow-500 dark:hover:bg-white dark:hover:text-gray-500 md:dark:hover:bg-transparent dark:border-gray-700' }}">
                        LABORATORIUM
                    </a>
                </li>
