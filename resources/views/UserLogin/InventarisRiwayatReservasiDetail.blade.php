...
@section('content')
    <section class="mx-24 bg-white flex flex-col">
        ...
        {{-- Header section --}}
        <div class="py-4">
            <div class="lg:text-4xl text-xl font-bold text-[#628F8E] lg:mb-6 mb-4">
                Detail Riwayat Reservasi Inventaris
            </div>
        ...
        <div class="mt-8 mb-18 relative border border-[#4C8F8B]" style="background-color: rgba(76, 143, 139, 0.1);">
            ...
            <div class="flex text-justify lg:px-20 lg:pt-6 pt-6 lg:pb-6 px-6 pb-4 text-xl font-bold lg:text-xl text-[#499DBC]">
                Informasi
            </div>
                ...
                <div class="overflow-x-auto md:overflow-x-auto rounded-lg shadow-xl border border-[#CBCBCB]">
                    <table class="w-full">
                        <thead class="bg-[#F8F7FC] border-b-2 border-gray-200">
                            <tr>
                                <th class="py-6 px-4 text-sm md:text-md lg:text-xl font-semibold tracking-wide text-[#628F8E] text-center border-r border-gray-200">
                                    Jenis Inventaris
                                </th>
                                <th class="py-6 px-4 text-sm md:text-md lg:text-xl font-semibold tracking-wide text-[#628F8E] text-center border-r border-gray-200">
                                    No Id
                        ...
                        <tbody class="divide-y divide-gray-100">
                            <tr class="bg-[#F8F7FC]">
                                <td class="p-3 text-sm md:text-base lg:text-base text-gray-700 whitespace-nowrap border-r border-gray-200">
                                    {{ $reservation['inventory']['item_name'] }}
                                </td>
                                <td class="p-3 text-sm md:text-base lg:text-base text-gray-700 whitespace-nowrap border-r border-gray-200">
                                    {{ $reservation['inventory']['no_item'] }}
                                </td>
                                <td class="p-3 text-sm md:text-base lg:text-base text-gray-700 whitespace-nowrap border-r border-gray-200">
                                    {{ $reservation['inventory']['information'] }}
                                </td>
                                <td class="p-3 text-sm md:text-base lg:text-base text-gray-700 whitespace-nowrap border-r border-gray-200">
