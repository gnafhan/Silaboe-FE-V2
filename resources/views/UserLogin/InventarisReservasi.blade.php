    ...
    <section class="lg:mx-24 mx-16 bg-white flex flex-col">
        ...
        <div class="flex flex-col">
                ...
                <div class="overflow-x-auto md:overflow-x-auto rounded-2xl shadow-xl">
                    <table class="w-full">
                        ...
                        <tbody class="divide-y divide-gray-100">
                            ...
                            <tr class="bg-[#F8F7FC]">
                                <td
                                    class="py-4 pl-8 pr-12 text-sm md:text-base lg:text-base text-gray-700 whitespace-nowrap border-r border-gray-200">
                                    Meja PC Server
                                </td>
                                <td
                                    class="py-4 px-8 text-sm md:text-base lg:text-base text-gray-700 whitespace-nowrap border-r border-gray-200">
            ...
            <div class="flex flex-row gap-4 mb-16 justify-start ">
                <a href="{{ Route('reservasiinventarisnull.login') }}" type="submit"
                ...
                <a href="{{ Route('formreservasiinventaris.login') }}" type="submit"
                    class="text-white bg-[#499DBC] hover:bg-[#2c6b81] focus:ring-4 focus:outline-none focus:ring-blue-300 font-reguler rounded-md lg:text-md md:text-md text-sm w-max-xl lg:w-max-auto md:w-max-auto lg:px-4 lg:py-3.5 px-4 py-3 text-center dark:bg-[#499DBC] ">Ajukan
                    Reservasi</a>
            </div>
        </div>
