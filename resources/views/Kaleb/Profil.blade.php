...
<header class="bg-[#628F8E] text-white flex items-center justify-between px-8 py-6 sticky w-full top-0">
    ...
    <div class="flex-1 lg:mx-20 mx-6 py-8 flex-col flex lg:gap-4 md:gap-4 gap-2">
        <div class="bg-gray-200 p-6 rounded-xl w-full lg:mx-auto shadow-lg">
            <div
                ...
                <div class="flex items-center space-x-4">
                    <img src="{{ asset('image/Profile.png') }}" alt="foto profil" class="w-16 h-16 rounded-full object-cover">
                    <div>
                ...
                <button
                    class="flex items-center  space-x-2 bg-[#4C8F8B] text-white py-2 lg:px-7 md:px-6 px-10 rounded-2xl hover:bg-green-600 lg:text-lg text-md font-medium">
                    <span>Edit</span>
