    ...
    <section class="flex-1 lg:mx-20 mx-12 my-6
     flex-col flex lg:gap-4 md:gap-4 gap-4">
        ...
        <div class="flex flex-row gap-4 w-full md:w-auto">
            <div
                class="flex flex-row gap-3 items-center bg-[#499DBC] px-6 py-2 hover:bg-[#608B8A] justify-center w-full md:w-auto rounded-xl">
            ...
            <div
                class="shadow-md flex flex-row gap-2 items-center bg-[#D46857] px-6 py-2 rounded-xl hover:bg-[#608B8A] justify-center w-full md:w-auto">
                <button class="font-medium text-md lg:text-lg text-white flex items-center">
                    Reject
                </button>
                <svg width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                        d="M7.33333 6.27778L13.6667 14.7222M13.6667 6.27778L7.33333 14.7222M10.5 20C13.0196 20 15.4359 18.9991 17.2175 17.2175C18.9991 15.4359 20 13.0196 20 10.5C20 7.98044 18.9991 5.56408 17.2175 3.78249C15.4359 2.00089 13.0196 1 10.5 1C7.98044 1 5.56408 2.00089 3.78249 3.78249C2.00089 5.56408 1 7.98044 1 10.5C1 13.0196 2.00089 15.4359 3.78249 17.2175C5.56408 18.9991 7.98044 20 10.5 20Z"
        ...
        <div class="flex justify-start mt-8">
            <button
                class="mt-6 bg-[#4C8F8B] text-white px-8 py-2 rounded-xl flex items-center font-semibold lg:text-lg text-md">
