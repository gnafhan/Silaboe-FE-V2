            ...
            <div class="p-4 rounded-xl w-full  mx-auto">
                ...
                <form>
                    ...
                    <div class="flex justify-start space-x-4 mt-24">
                        <a href="{{ Route('profil.admin') }}" type="button"
                            class="bg-[#D46857] hover:scale-105 text-white py-2 px-6 rounded-xl hover:bg-red-600 font-medium">Cancel</a>
                        <a href="#" type="submit"
                            class="bg-[#4C8F8B] hover:scale-105 text-white py-2 px-6 rounded-xl hover:bg-teal-500 font-medium">Submit</a>
                    </div>
                </form>
            </div>`
        </div>
