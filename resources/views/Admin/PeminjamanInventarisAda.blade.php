            ...
            <div class="overflow-x-auto rounded-xl shadow-xl">
                <table class="w-full min-w-[600px]">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        <tr class="bg-white">
                            <td
                                class="p-2 sm:p-3 text-xs sm:text-sm md:text-base lg:text-md text-gray-700 whitespace-nowrap border-r border-gray-200">
                            ...
                            <td
                                class="p-2 sm:p-3 text-xs sm:text-sm lg:text-md text-gray-700 whitespace-nowrap border-gray-200 border-r">
                                <span
                                    class="px-2 sm:px-4 py-1 sm:py-2 text-xs sm:text-sm font-medium tracking-wider text-white bg-[#499DBC] rounded-xl">Published</span>
                            </td>
                            <td
                                ...
                                <a href="{{ Route('peminjamaninvenatrisdetail.admin ') }}"
                                    class=" hover:bg-gray-700 px-4 sm:px-6 py-1 sm:py-2 text-xs sm:text-sm font-medium uppercase tracking-wider text-white bg-[#4C8F8B] rounded-xl">Lihat</button>
                            </td>
                        </tr>
                        <tr class="bg-white">
                            <td
                            ...
                            <td
                                class="p-2 sm:p-3 text-xs sm:text-sm lg:text-md text-gray-700 whitespace-nowrap border-gray-200 border-r flex justify-center items-center">
                                <button
                                    class="px-4 sm:px-6 py-1 sm:py-2 text-xs sm:text-sm font-medium uppercase tracking-wider text-white bg-[#4C8F8B] rounded-xl">Lihat</button>
                            </td>
                        </tr>
                        <tr class="bg-white">
                            <td
                            ...
                            <td
                                class="p-2 sm:p-3 text-xs sm:text-sm lg:text-md text-gray-700 whitespace-nowrap border-gray-200 border-r">
                                <span
                                    class="px-2 sm:px-4 py-1 sm:py-2 text-xs sm:text-sm font-medium tracking-wider text-white bg-[#D46857] rounded-xl ">Rejected</span>
                            </td>
                            <td
                                class="p-2 sm:p-3 text-xs sm:text-sm lg:text-md text-gray-700 whitespace-nowrap border-gray-200 border-r flex justify-center items-center">
                                <button
